...
import { pageLinks } from './config-footer-links';
...
export default function Footer() {
  ...
  // Use the pageLinks imported from config-footer-links
  const desktopList = pageLinks;

  // For mobile, use the same structure
